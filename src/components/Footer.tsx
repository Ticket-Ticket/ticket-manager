  ...
  return (
    <footer className="mt-12 py-8 border-t border-pink-100">
      <div className="max-w-lg mx-auto px-4">
        {/* リンク */}
        <nav className="flex flex-wrap justify-center gap-x-5 gap-y-2 text-sm text-gray-500 mb-4">
          ...
          <Link href="/privacy#disclaimer" className="hover:text-pink-500 transition-colors">
            免責事項
          </Link>
          <a
